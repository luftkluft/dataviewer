...
exports.hint = void 0;
var getAddressByPosition_1 = require("../../make_func/make_parser/get_address_by_position/getAddressByPosition");
var getNameByPosition_1 = require("../../make_func/make_parser/get_name_by_position/getNameByPosition");
var getCommentByPosition_1 = require("../../make_func/make_parser/get_comment_by_position/getCommentByPosition");
...
var hintsWord = function (file, sSource, sError, charCount) {
    var sHint = '\n';
    sHint += "\u0410\u0434\u0440\u0435\u0441: " + (0, getAddressByPosition_1.getAddressByPosition)(file, charCount) + "\n";
    sHint += "\u0418\u043C\u044F: " + (0, getNameByPosition_1.getNameByPosition)(file, charCount) + "\n";
    sHint += "\u041A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0439: " + (0, getCommentByPosition_1.getCommentByPosition)(file, charCount) + "\n";
    sHint += "\u0417\u043D\u0430\u0447\u0435\u043D\u0438\u0435 \u0432 \u043E\u0431\u0440\u0430\u0437\u0446\u043E\u0432\u043E\u0439 \u0446\u0438\u043A\u043B\u043E\u0433\u0440\u0430\u043C\u043C\u0435: " + sSource + "\n";
    sHint += "\u0417\u043D\u0430\u0447\u0435\u043D\u0438\u0435 \u0432 \u0430\u0432\u0430\u0440\u0438\u0439\u043D\u043E\u043C \u043B\u043E\u0433\u0435: " + sError + "\n";
    return sHint;
};
var hintsBit = function (file, maxMatchLineI, errorLogLineI, charCount) {
    var sHint = '\n';
    sHint += "\u0410\u0434\u0440\u0435\u0441: " + (0, getAddressByPosition_1.getAddressByPosition)(file, charCount) + "\n";
    sHint += "\u0418\u043C\u044F: " + (0, getNameByPosition_1.getNameByPosition)(file, charCount) + "\n";
    sHint += "\u041A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0439: " + (0, getCommentByPosition_1.getCommentByPosition)(file, charCount) + "\n";
...
function hint(file, maxMatchLine, errorMainLine) {
    try {
        var sHint = '';
        var match = 0;
        var charMatch = 0;
